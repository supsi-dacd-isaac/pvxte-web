...
if __name__ == '__main__':
    ...
    tolerance = args.mip_gap
    nrel_time = args.nrel_time
    power = args.power
    ...
    charge_time = charge_time.split(',')
    charge_time = list(map(int, charge_time))
    ...
    e = Env("gurobi.log", params={'MemLimit': 25,
                                  'PreSparsify': 1,
                                  'MIPFocus': 3,
                                  'NodefileStart': 0.5,
                                  'Heuristics': 0.3,
                                  'Presolve': 1,
                                  'NonConvex': 2,
                                  'NoRelHeurTime': nrel_time,
                                  'MIPGap': tolerance,
                                  'Threads': 4})
    for ctime in charge_time:
        ...
        with open(f'./results/{config_type}-{sub}-t{ctime}-{power}.csv', 'w', newline='') as f:
